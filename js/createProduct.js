getId("Create-product-btn").addEventListener("click", (event) => {
  ...
  sellProductCard.innerHTML = `
    <div id="sell-product-img-${num}" class="p-2 hover:bg-zinc-600 rounded-lg border md:h-[200px]"><img src="${img}" alt="Image" class="rounded-lg shadow shadow-white w-full h-full object-cover"></div>
                    <h2 id="sell-product-title-${num}" class="font-semibold text-2xl text-zinc-200 line-clamp-3">${productTitle}</h2>
